...
//   ];
  ...
  constructor() {
    super();
    // console.log("News constructor. Setting state");
    this.state = {
      articles: [],
      loading: false,
      page:1,
  ...
  async componentDidMount(){
    console.log("cdm");
    let url = "https://newsapi.org/v2/top-headlines?country=us&apiKey=a289c3a5b2554d9fa77b374e146b1d7b&page=1&pageSize=18";
  ...
  handlePreviousClick = async () => {
    let url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=a289c3a5b2554d9fa77b374e146b1d7b&page=${this.state.page-1}&pageSize=18`;
    let data = await fetch(url);
    let parsedData = await data.json();    
    this.setState({
  ...
  render() {
    ...
    return (
      <div className="container my-3">
        <h1 className="text-center"> NewsRaptor - Top Headlines</h1>
        <div className="row">
